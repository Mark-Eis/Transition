...
We can now add a column of previous test results using the \code{add\_prev\_result()} function with default values for all but the first argument: -
...
We can now add a column of test result transitions using \code{add\_transitions()} function with default values for all but the first argument: -
