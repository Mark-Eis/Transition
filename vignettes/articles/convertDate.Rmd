...
This vignette explains how timepoints represented by numeric values in data may be easily converted to class `"Date"`, using the R **base** package function [`as.Date()`](https://stat.ethz.ch/R-manual/R-devel/library/base/html/as.Date.html).
